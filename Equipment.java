...
public class Equipment
{
    ...
    public boolean equals(Object other)
    {
    	...
    	try {
			Assert.assertEquals(otherEq.getName(), this.getName());
	    	Assert.assertEquals(otherEq.getCount(), this.getCount());
	    	Assert.assertEquals(otherEq.getTotalWeight(), this.getTotalWeight());
	    	Assert.assertEquals(otherEq.getTotalPrice(), this.getTotalPrice());
	    	Assert.assertEquals(otherEq.getDescription(), this.getDescription());
		} catch (AssertException e) {
			System.out.println("Equipments not equal!");
			return false;
		}
