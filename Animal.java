...
public class Animal
{
    ...
    public boolean equals(Object other)
    {
    	...
    	try {
			Assert.assertEquals(otherAni.getName(), this.getName());
	    	Assert.assertEquals(otherAni.getHeight(), this.getHeight());
	    	Assert.assertEquals(otherAni.getWeight(), this.getWeight());
	    	Assert.assertEquals(otherAni.getColor(), this.getColor());
		} catch (AssertException e) {
			System.out.println("Animals not equal!");
			return false;
		}
